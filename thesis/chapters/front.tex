...
Las capturas de pantalla de esta sección corresponden al Perfil del estudiante del autor de este documento, salvo que en la descripción se indique lo contrario.
...
\begin{enumerate}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/nes/promedios_relativo.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/nes/porcentaje_estandar.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/nes/porcentaje_relativo.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/nes/porcentaje_periodo_estandar.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/nes/porcentaje_periodo_relativo.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/nes/creditos_estandar.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/nes/creditos_relativo.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/nes/creditos_periodo_estandar.png}
